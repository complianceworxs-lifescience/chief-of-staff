...
- **CONSTITUTION VALIDATOR ROUTINE**: L5 Action Loop middleware that validates every action against forbidden vocabulary, spending limits, and forbidden claims before execution, logging all violations.
