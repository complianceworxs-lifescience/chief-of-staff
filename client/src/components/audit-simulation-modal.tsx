...
const auditQuestionPool: Omit<AuditQuestion, "status" | "findings">[] = [
  {
    ...
    question: "Show me the evidence for design verification and validation activities.",
    expectedEvidence: "Design verification matrix, test protocols, and validation reports.",
  },
  {
    id: "q2",
    category: "Document Control",
    question: "How do you ensure document revision control and approval?",
    expectedEvidence: "Document control procedure with revision history and approval signatures.",
  },
  {
    id: "q3",
    category: "CAPA",
    question: "Demonstrate your corrective action effectiveness verification process.",
    expectedEvidence: "CAPA procedure with root cause analysis and effectiveness checks.",
  },
  {
    id: "q4",
    category: "Training",
    question: "Show training records for personnel performing quality-critical tasks.",
    expectedEvidence: "Training matrix and competency assessments with signatures.",
  },
  {
    id: "q5",
    category: "Complaint Handling",
    question: "Walk me through your complaint evaluation and MDR assessment process.",
    expectedEvidence: "Complaint handling SOP with reportability decision tree.",
  },
  {
    id: "q6",
    category: "Supplier Control",
    question: "How do you qualify and monitor critical suppliers?",
    expectedEvidence: "Supplier qualification records, audits, and performance monitoring data.",
  },
  {
    id: "q7",
    category: "Risk Management",
    question: "Show me the risk management file for your product.",
    expectedEvidence: "Risk analysis, risk evaluation, and risk control measures per ISO 14971.",
  },
  {
    id: "q8",
    category: "Production Control",
    question: "Demonstrate traceability from raw materials to finished product.",
    expectedEvidence: "Batch records with lot traceability and inspection results.",
  },
];
